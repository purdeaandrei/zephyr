...
/*
 * @brief utility function, grouping control ep code, called by usb_dc_ep_read_continue
 *
 * @param [in] ep_state          ep0_out state
 * @param [out] arm_out_endpoint set to true, if more data transactions are expected
 *
 * @return error code
 */
